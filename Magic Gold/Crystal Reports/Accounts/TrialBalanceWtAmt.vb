...
Public Class TrialBalanceWtAmt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Magic_Gold.TrialBalanceWtAmt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTrialBalanceWtAmt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TrialBalanceWtAmt = New TrialBalanceWtAmt()
        rpt.Site = Me.Site
        Return rpt
    End Function
