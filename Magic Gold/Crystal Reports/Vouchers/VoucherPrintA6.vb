...
Public Class VoucherPrintA6
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Magic_Gold.VoucherPrintA6.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVoucherPrintA6
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VoucherPrintA6 = New VoucherPrintA6()
        rpt.Site = Me.Site
        Return rpt
    End Function
