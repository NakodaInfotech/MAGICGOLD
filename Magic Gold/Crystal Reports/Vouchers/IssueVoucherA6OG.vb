...
Public Class IssueVoucherA6OG
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Magic_Gold.IssueVoucherA6OG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIssueVoucherA6OG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IssueVoucherA6OG = New IssueVoucherA6OG()
        rpt.Site = Me.Site
        Return rpt
    End Function
