...
Public Class VoucherPrintA6Direct
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "VoucherPrintA6Direct.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Magic_Gold.VoucherPrintA6Direct.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVoucherPrintA6Direct
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VoucherPrintA6Direct = New VoucherPrintA6Direct()
        rpt.Site = Me.Site
        Return rpt
    End Function
