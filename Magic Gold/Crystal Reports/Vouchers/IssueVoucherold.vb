...
Public Class IssueVoucherold
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Magic_Gold.IssueVoucherold.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIssueVoucherold
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IssueVoucherold = New IssueVoucherold()
        rpt.Site = Me.Site
        Return rpt
    End Function
