...
Public Class DailyKhataReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Magic_Gold.DailyKhataReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailyKhataReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailyKhataReport = New DailyKhataReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
