...
Public Class VoucherPrintold
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Magic_Gold.VoucherPrintold.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVoucherPrintold
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VoucherPrintold = New VoucherPrintold()
        rpt.Site = Me.Site
        Return rpt
    End Function
