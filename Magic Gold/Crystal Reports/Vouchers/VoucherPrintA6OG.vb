...
Public Class VoucherPrintA6OG
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Magic_Gold.VoucherPrintA6OG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVoucherPrintA6OG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VoucherPrintA6OG = New VoucherPrintA6OG()
        rpt.Site = Me.Site
        Return rpt
    End Function
