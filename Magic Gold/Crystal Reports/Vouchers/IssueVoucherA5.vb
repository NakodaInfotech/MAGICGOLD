...
Public Class IssueVoucherA5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Magic_Gold.IssueVoucherA5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIssueVoucherA5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IssueVoucherA5 = New IssueVoucherA5()
        rpt.Site = Me.Site
        Return rpt
    End Function
