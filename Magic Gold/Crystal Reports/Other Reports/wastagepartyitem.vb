...
Public Class wastagepartyitem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Magic_Gold.wastagepartyitem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedwastagepartyitem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As wastagepartyitem = New wastagepartyitem()
        rpt.Site = Me.Site
        Return rpt
    End Function
