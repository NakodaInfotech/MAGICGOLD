...
Public Class ItemPurityReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Magic_Gold.ItemPurityReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedItemPurityReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ItemPurityReport = New ItemPurityReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
