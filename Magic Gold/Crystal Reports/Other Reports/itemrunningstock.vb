...
Public Class itemrunningstock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Magic_Gold.itemrunningstock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheditemrunningstock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As itemrunningstock = New itemrunningstock()
        rpt.Site = Me.Site
        Return rpt
    End Function
