...
Partial Class StockWithKarigarWastage
    ...
    Private Sub InitializeComponent()
        ...
        Me.GKARIGARGROSS = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.GKARIGARNETT = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.GWASTAGEGROSS = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.GGROSSLESS = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.BlendPanel1.Size = New System.Drawing.Size(1284, 592)
        ...
        Me.GRIDKARIGAR.Size = New System.Drawing.Size(440, 284)
        ...
        Me.GRIDKARIGARDETAILS.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.GNAME, Me.GKARIGARGROSS, Me.GKARIGARNETT})
        ...
        'GKARIGARGROSS
        '
        Me.GKARIGARGROSS.Caption = "Gross Wt"
        Me.GKARIGARGROSS.DisplayFormat.FormatString = "0.000"
        Me.GKARIGARGROSS.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.GKARIGARGROSS.FieldName = "GROSSWT"
        Me.GKARIGARGROSS.Name = "GKARIGARGROSS"
        Me.GKARIGARGROSS.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum)})
        Me.GKARIGARGROSS.Visible = True
        Me.GKARIGARGROSS.VisibleIndex = 1
        Me.GKARIGARGROSS.Width = 100
        '
        'GKARIGARNETT
        '
        Me.GKARIGARNETT.Caption = "Nett Wt"
        Me.GKARIGARNETT.DisplayFormat.FormatString = "0.000"
        Me.GKARIGARNETT.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.GKARIGARNETT.FieldName = "NETTWT"
        Me.GKARIGARNETT.Name = "GKARIGARNETT"
        Me.GKARIGARNETT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum)})
        Me.GKARIGARNETT.Visible = True
        Me.GKARIGARNETT.VisibleIndex = 2
        Me.GKARIGARNETT.Width = 100
        '
        'GRIDWASTAGE
        '
        ...
        Me.GRIDWASTAGEDETAILS.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.GWASTAGE, Me.GWASTAGEGROSS})
        ...
        'GWASTAGEGROSS
        '
        Me.GWASTAGEGROSS.Caption = "Gross Wt"
        Me.GWASTAGEGROSS.DisplayFormat.FormatString = "0.000"
        Me.GWASTAGEGROSS.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.GWASTAGEGROSS.FieldName = "GROSSWT"
        Me.GWASTAGEGROSS.Name = "GWASTAGEGROSS"
        Me.GWASTAGEGROSS.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum)})
        Me.GWASTAGEGROSS.Visible = True
        Me.GWASTAGEGROSS.VisibleIndex = 1
        Me.GWASTAGEGROSS.Width = 100
        '
        'CMDOK
        '
        ...
        Me.GRIDDETAILS.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.GITEMCODE, Me.GNARRATION, Me.gpurity, Me.GGROSSWT, Me.GLESSWT, Me.GGROSSLESS, Me.GFINEWT})
        ...
        'GFINEWT
        '
        Me.GFINEWT.AppearanceCell.Options.UseTextOptions = True
        Me.GFINEWT.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far
        Me.GFINEWT.AppearanceHeader.Options.UseTextOptions = True
        Me.GFINEWT.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
        ...
        Me.GLESSWT.VisibleIndex = 4
        Me.GLESSWT.Width = 100
        '
        'GGROSSLESS
        '
        Me.GGROSSLESS.Caption = "Nett Wt"
        Me.GGROSSLESS.DisplayFormat.FormatString = "0.000"
        Me.GGROSSLESS.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
        Me.GGROSSLESS.FieldName = "GROSSLESS"
        Me.GGROSSLESS.Name = "GGROSSLESS"
        Me.GGROSSLESS.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum)})
        Me.GGROSSLESS.Visible = True
        Me.GGROSSLESS.VisibleIndex = 5
        Me.GGROSSLESS.Width = 100
        '
        'ToolStrip1
        '
        ...
        Me.KeyPreview = True
        Me.Name = "StockWithKarigarWastage"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.Manual
        Me.Text = "Stock With Karigar A/C & Wastage"
    ...
    Friend WithEvents GKARIGARGROSS As DevExpress.XtraGrid.Columns.GridColumn
    ...
    Friend WithEvents GWASTAGEGROSS As DevExpress.XtraGrid.Columns.GridColumn
    ...
    Friend WithEvents GKARIGARNETT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents GLESSWT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents GGROSSLESS As DevExpress.XtraGrid.Columns.GridColumn
End Class
